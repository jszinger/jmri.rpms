...
#BuildRequires: mvn(io.takari.maven.plugins:takari-plugin-integration-testing)
...
%pom_remove_dep io.takari.maven.plugins:takari-plugin-testing
%pom_remove_dep io.takari.maven.plugins:takari-plugin-integration-testing
...
%changelog
* Mon Mar 26 2018 J Szinger <szinger@f27mate> - 1.4-1
- update to 1.4
